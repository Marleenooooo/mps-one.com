...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.vendor_risk': 'Vendor Risk Assessment',
    'nav.budget_forecasting': 'Budget Forecasting',
    'nav.contract_negotiation': 'Contract Negotiation',
    'nav.supplier_performance': 'Supplier Performance Review',
    'nav.document_integrations': 'Document Integrations',
    'nav.erp_connectors': 'ERP Connectors',
    'nav.realtime': 'Real-Time',
    'nav.analytics': 'Analytics',
    'nav.payment_reconciliation': 'Payment Reconciliation',
  ...
  id: {
    ...
    'nav.vendor_risk': 'Penilaian Risiko Vendor',
    'nav.budget_forecasting': 'Peramalan Anggaran',
    'nav.contract_negotiation': 'Negosiasi Kontrak',
    'nav.supplier_performance': 'Tinjauan Performa Pemasok',
    'nav.payment_reconciliation': 'Rekonsiliasi Pembayaran',
