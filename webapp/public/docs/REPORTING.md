...
## Overview
- Spending analysis, vendor performance, and budget utilization across departments.

## Key Reports
- Spending per department/vendor/period.
- PO lifecycle durations and delivery performance.
- Payment status distribution (paid, waiting, next, overdue).

## Export
- Tables and charts are export‑ready with filters.
